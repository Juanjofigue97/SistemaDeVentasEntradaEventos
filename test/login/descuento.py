...
# Ingresar código de descuento DL30
try:
    input_codigo = driver.find_element(By.XPATH, '//input[@placeholder="Ingresa el código"]')
    input_codigo.send_keys("DL30")
    print("✅ Código DL30 ingresado")
except:
    print("❌ No se encontró el campo del código")

time.sleep(1)

# Clic en el botón "Aplicar"
try:
    boton_aplicar = driver.find_element(By.XPATH, '//button[contains(text(), "Aplicar")]')
    boton_aplicar.click()
    print("✅ Clic en botón Aplicar")
except:
    print("❌ No se encontró el botón Aplicar")

time.sleep(2)

# Clic en el botón OK del SweetAlert
try:
    boton_ok = driver.find_element(By.CLASS_NAME, 'swal2-confirm')
    boton_ok.click()
    print("✅ Clic en botón OK del mensaje")
except:
    print("❌ No se encontró el botón OK del SweetAlert")
